...
class Settings(BaseSettings):
    ...
    s3_cdn_domain: Optional[str] = Field(default=None, env="S3_CDN_DOMAIN")
    s3_signing_secret: Optional[str] = Field(default=None, env="S3_SIGNING_SECRET")
    ...
    # App Settings
    app_name: str = Field(default="Writers Room X", env="APP_NAME")
